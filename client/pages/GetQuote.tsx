      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 animate-on-scroll">Request Your Quote</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto animate-on-scroll">
              Fill out this form with your requirements and we'll provide you with a detailed proposal within 24 hours.
            </p>
          </div>
          ...
          <Card className="shadow-xl animate-on-scroll">
            <CardHeader>
              ...
              <CardDescription>
                Please provide as much detail as possible to help us create an accurate quote for your needs.
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div>
                    ...
                    <Select onValueChange={(value) => handleSelectChange('serviceType', value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="leadership-hiring">Strategic Leadership Hiring</SelectItem>
                        <SelectItem value="lateral-bulk">Lateral & Bulk Hiring</SelectItem>
                        <SelectItem value="campus-placements">Campus Placements</SelectItem>
                        <SelectItem value="industry-training">Industry Training</SelectItem>
                        <SelectItem value="diversity-sourcing">Diversity Sourcing</SelectItem>
                  ...
                  <div>
                    ...
                    <Select onValueChange={(value) => handleSelectChange('budget', value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="above-50-lakh">Above ₹50 Lakhs</SelectItem>
                ...
                {submitStatus === 'success' && (
                  <div className="bg-green-50 border border-green-200 rounded-md p-4">
                    <p className="text-green-800">
                      Thank you! Your quote request has been submitted successfully. We'll get back to you within 24 hours with a detailed proposal.
                    </p>
                  </div>
                )}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 animate-on-scroll">Why Choose Intelligate Solutions?</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto animate-on-scroll">
              Experience the difference with our proven approach to recruitment and talent acquisition.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="professional-card animate-on-scroll">
              ...
              <CardContent className="text-center">
                <p className="text-gray-700">
                  Our experienced recruiters are MBAs and B.Tech professionals with deep industry knowledge.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="professional-card animate-on-scroll">
              ...
              <CardContent className="text-center">
                <p className="text-gray-700">
                  Track record of successful placements across diverse industries and experience levels.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="professional-card animate-on-scroll">
              ...
              <CardContent className="text-center">
                <p className="text-gray-700">
                  Tailored recruitment strategies designed specifically for your unique requirements.
                </p>
              </CardContent>
            </Card>
          </div>
